...
<% 
	...
	String staffname11= request.getParameter("staffname11");
	int staffid11= Integer.parseInt(request.getParameter("staffid11"));
try
{
	...
	int i= st.executeUpdate("delete from gitDB.staff where staff_id= '"+staffid11+"'");
...
<div>
<a class= "buttonLink" href="staff1.jsp">Go back to last page</a>
</div>
</br></br>
