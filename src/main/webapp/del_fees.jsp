				...
				<%@page import="java.sql.Connection" %>
					...
					<body>
						...
						try {
							...
							int i=st.executeUpdate("delete from gitDB.fees where depart_id='"+depart_id+"'");
							out.println(" System Succefully deleted "+depart_id+" from GIT fees database"); 
						}catch(Exception e){ 
							System.out.print(e);
							e.printStackTrace(); } %>

							<div>
								<a href="Fees.jsp">Go back to last page</a>
							</div>
							</br></br>
